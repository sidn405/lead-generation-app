...
def add_package_to_database(username: str, package_name: str):
    ...
    packages = {
        ...
        "Professional Starter": {"leads": 500, "price": 97, "file": "fitness_business_professionals_500.csv", "category": "Business Professionals"},
        "Professional Growth": {"leads": 2500, "price": 397, "file": "fitness_business_professionals_2500.csv", "category": "Business Professionals"},
        "Professional Empire": {"leads": 5000, "price": 897, "file": "fitness_business_professionals_5000.csv", "category": "Business Professionals"}
    }
